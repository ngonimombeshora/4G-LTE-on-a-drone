...
class deploySanityCheckTest():
    ...
    def deployHSS(self):
        ...
        if entrypoint is not None:
            subprocess_run_w_echo('wget --quiet https://raw.githubusercontent.com/OPENAIRINTERFACE/openair-hss/develop/ci-scripts/generateConfigFiles.py -O ci-scripts/generateHssConfigFiles.py')
            subprocess_run_w_echo('python3 ci-scripts/generateHssConfigFiles.py --kind=HSS --cassandra=' + CI_CASS_IP_ADDR + ' --hss_s6a=' + CI_HSS_S6A_ADDR + ' --from_docker_file --env_for_entrypoint')
